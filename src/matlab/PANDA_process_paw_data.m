function [PAW2,EVENTS] = PANDA_process_paw_data(PAW, good_string_pull_intervals_uSec)
...
[PAW2.Right_speed, PAW2.Right_acc] = PANDA_Speed_from_xy(PAW.Time_uSec/1e6, PAW.Right_x, PAW.Right_y, bad_speed_thresh);
[PAW2.Left_speed, PAW2.Left_acc] = PANDA_Speed_from_xy(PAW.Time_uSec/1e6, PAW.Left_x, PAW.Left_y, bad_speed_thresh);
[PAW2.Nose_speed] = PANDA_Speed_from_xy(PAW.Time_uSec/1e6,PAW.Nose_x, PAW.Nose_y, bad_speed_thresh);
