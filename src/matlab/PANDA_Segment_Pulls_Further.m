function [OUT] = PANDA_Segment_Pulls_Further(varargin)
...
[FCam, FCam_intervals] = PANDA_Load_and_Clean_DLC_Front_Camera_Tracking(fullfile(SES.Front_cam_dir,'Front_Cam_Pos.mat'));
...
for i=1:length(eventNames)
    for j=1:length(EVENTS.(eventNames{i}))
        ...
        idx.(eventNames{i})(j)=find(FCam.Time_uSec==EVENTS.(eventNames{i})(j),1);
