...
for iCycle = 1:Rows(intervals)
    ...
    PULLSEG.Lift.Left.start_end_t_uS(iCycle,:) = SEG.Intan_uS(lift_ix([1 end]))';
    PULLSEG.Advance.Left.start_end_t_uS(iCycle,:) = SEG.Intan_uS(advance_ix([1 end]))';
    PULLSEG.Grasp.Left.start_end_t_uS(iCycle,:) = SEG.Intan_uS(grasp_ix([1 end]))';
    PULLSEG.Pull.Left.start_end_t_uS(iCycle,:) = SEG.Intan_uS(pull_ix([1 end]))';
    PULLSEG.Push.Left.start_end_t_uS(iCycle,:) = SEG.Intan_uS(push_ix([1 end]))';
...
for iCycle = 1:Rows(intervals)
    ...
    PULLSEG.Lift.Right.start_end_t_uS(iCycle,:) = SEG.Intan_uS(lift_ix([1 end]))';
    PULLSEG.Advance.Right.start_end_t_uS(iCycle,:) = SEG.Intan_uS(advance_ix([1 end]))';
    PULLSEG.Grasp.Right.start_end_t_uS(iCycle,:) = SEG.Intan_uS(grasp_ix([1 end]))';
    PULLSEG.Pull.Right.start_end_t_uS(iCycle,:) = SEG.Intan_uS(pull_ix([1 end]))';
    PULLSEG.Push.Right.start_end_t_uS(iCycle,:) = SEG.Intan_uS(push_ix([1 end]))';
