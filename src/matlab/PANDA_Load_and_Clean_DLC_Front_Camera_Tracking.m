function [SEG, INFO] = PANDA_Load_and_Clean_DLC_Front_Camera_Tracking(fname, varargin)
% load the output of post - processing - the mat file that has the post
% data.
% pth is the probabilty threshold for eliminating data. Confidence.
pth = .8;
