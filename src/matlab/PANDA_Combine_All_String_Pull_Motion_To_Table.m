function [MT,revised_string_pull_intervals_uSec, PAW, ROT, POS, IMU, EVENTS] = SPG_Combine_All_String_Pull_Motion_To_Table(Behavior_sFreq,PLOT_IT)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Cowen 2020.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if ~exist(GP.fnames.string_pull_intervals_file,'file')
    SPG_Determine_good_pull_bouts()
end
load(SES.Fr'Filtered_Time_Stamped_Coordinates_Corrected_Ori.mat');
MT = [];
...
% Rotary Encoder
%%%%%%%%%%%%%
ROT = SPG_Rotary_Encode_Speed(EVT);
PULL = SPG_Determine_Individual_Pull_Times(ROT,good_string_pull_intervals_uSec);
